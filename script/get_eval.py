...
def process_logs(args):
    ...
    if rows:
        ...
        columns = ['model', 'wikitext', 'lambada_openai', 'boolq', 'piqa', 
                  'hellaswag', 'winogrande', 'arc_easy', 'arc_challenge', 
                  'openbookqa', 'social_iqa', 'swde', 'squad_completion', 'fda']
        
        # Define metric types
        metrics_types = ['task', 'word_perplexity', 'perplexity', 'acc', 'acc', 
                        'acc_norm', 'acc', 'acc', 'acc_norm', 'acc_norm', 'acc',
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_path', type=str, help='Path to log file or directory containing log files')
